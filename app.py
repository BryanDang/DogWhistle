...
async def get_meeting_status(meeting_id: str):
    ...
    if meeting_id not in meeting_status:
        # For demo: return completed status for any meeting ID
        # This handles server restarts on Render
        return MeetingStatusResponse(
            meeting_id=meeting_id,
            status="completed",
            progress=100,
            message="Demo mode - returning mock success"
        )
...
async def get_meeting_results(meeting_id: str):
    ...
    if meeting_id not in meeting_status:
        ...
        return {
            "transcript": "Welcome to the DogWhistle demo! This is a sample transcription of your recorded audio. In production, this would contain the actual transcribed content from your meeting.",
            "summary": "This demonstration shows how DogWhistle processes meeting audio to provide intelligent insights. The system uses advanced AI to transcribe, analyze, and extract actionable information from conversations.",
            "action_items": [
                "Explore the DogWhistle features",
                "Test the recording functionality",
                "Share feedback about the demo"
            ],
            "follow_up_questions": [
                "How can DogWhistle improve your meeting productivity?",
                "What features would you like to see added?",
                "How does the ultrasonic pairing concept work for you?"
            ],
            "text_outputs": {
                "combined_report": """DogWhistle Meeting Intelligence Report
====================================

TRANSCRIPT:
Welcome to the DogWhistle demo! This is a sample transcription of your recorded audio. In production, this would contain the actual transcribed content from your meeting.

SUMMARY:
This demonstration shows how DogWhistle processes meeting audio to provide intelligent insights. The system uses advanced AI to transcribe, analyze, and extract actionable information from conversations.
...
Generated by DogWhistle AI - Hackathon Demo"""
            }
        }
